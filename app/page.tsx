  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose BlogVista?</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-0 shadow-lg bg-white rounded-lg">
              <div className="p-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Write Freely</h3>
            ...
            <div className="group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-0 shadow-lg bg-white rounded-lg">
              <div className="p-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Read Widely</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <div className="text-center">
            ...
            <div className="mt-8 pt-8 border-t border-gray-800">
              <p className="text-gray-400 text-sm">
                © {new Date().getFullYear()} BlogVista. Made with passion for storytellers everywhere.
              </p>
            </div>
          </div>
        </div>
