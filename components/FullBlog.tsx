  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="max-w-5xl mx-auto px-4 mb-8">
        <div className="relative rounded-2xl overflow-hidden shadow-2xl h-64 md:h-96">
          <Image src={thumbnail} alt={title} fill sizes="100vw" className="object-cover" priority />
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent" />
          <div className="absolute top-4 right-4 flex space-x-2">
            <button
              onClick={handleLike}
              className={`p-3 rounded-full backdrop-blur-sm transition-all duration-200 ${
                isLiked ? "bg-red-500 text-white shadow-lg" : "bg-white/20 text-white hover:bg-white/30"
              }`}
            >
      ...
      <div className="max-w-4xl mx-auto px-4 pb-12">
        <article className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <header className="mb-8">
            <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">{title}</h1>
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className={`flex items-center px-4 py-2 rounded-full transition-all duration-200 ${
                    isLiked ? "bg-red-500 text-white shadow-lg hover:bg-red-600" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                  }`}
                >
